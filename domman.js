...
//5. let foundDiv = document.querySelector("#container");
//   foundDiv.innerText = "Hello";

//6. let footer = document.querySelector(".footer");
//   footer.classList.add("main");

//7. let footer = document.querySelector(".footer");
...
//10. let list = document.querySelector("ul");
//    list.appendChild(newLi);

//11. let liInsideOl = document.querySelectorAll("ol li");
//    for(let i = 0; i < liInsideOl.length; i++){
//    liInsideOl[i].style.backgroundColor = "green";
//}

//12. let footer = document.querySelector(".footer");
//footer.remove();